...
api_path = "/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/devicegroups/devicegrouprecords"    # param
url = server + api_path
if (url[-1] == '/'):
    url = url[:-1]
...
post_data = {
	...
	"deviceGroup": {
		"id": json_resp['items'][0]['id']
	},
	"accessPolicy": {
		"id": "000C2977-DD95-0ed3-0000-021474836483"
	}
}
